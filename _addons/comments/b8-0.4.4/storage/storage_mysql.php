    ...
    function storage_mysql()
    {
        ...
        if($this->constructed) {
            ...
            if(!empty($arg)) {
                ...
                if(is_resource($arg) ) {
                ...
                else if (isset($arg['mysqlRes']) && is_resource($arg['mysqlRes'])) {
                    ...
                    if(isset($arg['tableName'])) {
                        ...
                        else $this->config['tableName'] = $arg['tableName'];
                    }
                }
                else {
                    # Set up the MySQL connection
                    $this->mysqlRes = mysql_connect($arg['host'], $arg['user'], $arg['pass']);
                    if (isset($arg['tableName'])) $this->config['tableName'] = $arg['tableName'];
                    if(!mysql_select_db($arg['db'])) {

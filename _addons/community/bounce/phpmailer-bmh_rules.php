...
function bmhSubjectRules($subject,$debug_mode=false) {
    ...
    $result = array(
      ...
      */
     elseif (preg_match ("/returned to sender/i",$subject,$match)) {
         $result['rule_cat']    = 'unknown';
         $result['rule_no']     = '0236';
     }
     elseif (preg_match ("/AutoReply/i",$subject,$match)) {
         $result['rule_cat']    = 'autoreply';
         $result['rule_no']     = '0167';
     }
     elseif (preg_match ("/Out of Office/i",$subject,$match)) {
         $result['rule_cat']    = 'autoreply';
         $result['rule_no']     = '0167';
     }
     elseif (preg_match ("/^Re: /i",$subject,$match)) {
         $result['rule_cat']    = 'autoreply';
         $result['rule_no']     = '0167';
     }
     elseif (preg_match ("/^AW: /i",$subject,$match)) {
         $result['rule_cat']    = 'autoreply';
         $result['rule_no']     = '0167';
     }
     elseif (preg_match ("/Urlaub/i",$subject,$match)) {
         $result['rule_cat']    = 'autoreply';
         $result['rule_no']     = '0167';
     }

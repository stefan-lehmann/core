...
$elements_in['label']		= cjoAddon::translate(21,'shop_get_credit_card_provider');
$elements_in['default']		= isset($pay_object) ? $pay_object->getCardProvider() : '';
$elements_in['validate']	= 'notEmpty';
$elements_in['error_msg']	= cjoAddon::translate(21,'msg_no_credit_card_provider');
...
$elements_in['label']		= cjoAddon::translate(21,'shop_get_credit_card_id');
$elements_in['default']		= isset($pay_object) ? $pay_object->getCardId() : '';
$elements_in['validate']	= 'numeric';
$elements_in['error_msg']	= cjoAddon::translate(21,'msg_no_credit_card_number');
$elements_in['required']	= 1;
$form_elements_in[]         = $elements_in;
...
$elements_in['label']		= cjoAddon::translate(21,'shop_get_credit_card_expiration');
...
$elements_in['error_msg']	= cjoAddon::translate(21,'msg_no_expiration_date');
$elements_in['required']	= 1;
...
$elements_in['label']		= cjoAddon::translate(21,'shop_get_credit_card_cvs');
...
$elements_in['error_msg']	= cjoAddon::translate(21,'msg_no_credit_card_cvs').'|'.cjoAddon::translate(21,'shop_err_nums_only').'|'.cjoAddon::translate(21,'shop_err_length_eq_3');
$elements_in['required']	= 1;
$elements_in['css']			= 'form_elm_smll';
$form_elements_in[]         = $elements_in;
...
$elements_in['default']		= cjoAddon::translate(21,'shop_credit_card_owner');
$elements_in['css']			= 'form_elm_headline';
$form_elements_in[]         = $elements_in;
...
$elements_in['label']		= cjoAddon::translate(21,'shop_get_credit_card_owner_firstname');
$elements_in['default']		= isset($pay_object) ? $pay_object->getFirstname() : '';
$elements_in['validate']	= 'notEmpty';
$elements_in['error_msg']	= cjoAddon::translate(21,'msg_no_credit_card_owner_name');
$elements_in['required']	= 1;
$form_elements_in[]         = $elements_in;
...
$elements_in['label']		= cjoAddon::translate(21,'shop_get_credit_card_owner_name');

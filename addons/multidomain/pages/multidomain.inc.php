...
if ($function == 'delete') {
	...
	$delete->Delete(cjoAddon::translate(15,'msg_item_deleted'));
	$function = '';
}
...
if ($function == "add" || $function == "edit" ) {
    ...
    $fields['servername']->addValidator('notEmpty', cjoAddon::translate(15,"msg_err_servername_notEmpty"), false, false);

    $fields['domain'] = new textField('domain', cjoAddon::translate(15,"label_domain"));
    $fields['domain']->addValidator('notEmpty', cjoAddon::translate(15,"msg_err_domain_notEmpty"), false, false);

    $fields['error_email'] = new textField('error_email', cjoI18N::translate("label_error_email"));
    $fields['error_email']->addValidator('notEmpty', cjoAddon::translate(15,"msg_err_error_email_notEmpty"), false, false);
    $fields['error_email']->addValidator('isEmail', cjoAddon::translate(15,"msg_err_error_email_notEmail"), false, false);

    $fields['root_article_id'] = new cjoLinkButtonField('root_article_id', cjoAddon::translate(15,'label_root_article_id'));
    $fields['root_article_id']->addValidator('notEmptyOrNull', cjoAddon::translate(15,"msg_err_root_article_id_notEmpty"), false, false);

    $fields['start_article_id'] = new cjoLinkButtonField('start_article_id', cjoAddon::translate(15,'label_start_article_id'));
    $fields['start_article_id']->addValidator('notEmptyOrNull', cjoAddon::translate(15,"msg_err_start_article_id_notEmpty"), false, false);

    $fields['notfound_article_id'] = new cjoLinkButtonField('notfound_article_id', cjoI18N::translate('label_notfound_article_id'));
    $fields['notfound_article_id']->addValidator('notEmptyOrNull', cjoAddon::translate(15,"msg_err_notfound_article_id_notEmpty"), false, false);

    //[translate_15: label_add_multidomain]
    //[translate_15: label_edit_multidomain]
    $section = new cjoFormSection(TBL_MULTIDOMAIN, cjoAddon::translate(15,"label_".$function."_multidomain"), array ('id' => $oid));
    ...
    if ($form->validate()){
	    ...
	    if ($sql->getRows() > 0) {
    		cjoMessage::addError(cjoAddon::translate(15,"msg_err_double_servername", $servername));
	    ...
	    if ($sql->getRows() > 0) {
    		cjoMessage::addError(cjoAddon::translate(15,"msg_err_double_domain", $domain));
	    ...
	    if ($sql->getRows() > 0) {
    		cjoMessage::addError(cjoAddon::translate(15,"msg_err_double_root_article_id"));
    	...
    	if (!OOArticle::isValid($root_article) ||
    		...
    		cjoMessage::addError(cjoAddon::translate(15,"msg_err_root_article_id"));
    		$fields['root_article_id']->addAttribute('class', 'invalid');
    		$form->valid_master = false;
    	}
        ...
        if (!OOArticle::isValid($start_article_id) || (
    		...
    		cjoMessage::addError(cjoAddon::translate(15,"msg_err_start_article_id"));
        ...
        if (!OOArticle::isValid($notfound_article_id) || (
    		...
    		cjoMessage::addError(cjoAddon::translate(15,"msg_err_notfound_article_id"));
        ...
        if ($form->valid_master == true && cjo_post('cjoform_save_button','bool')) {
            if ($function == 'edit') {
                cjoMessage::addSuccess(cjoAddon::translate(15,"msg_item_updated"));
            }
            else {
                cjoMessage::addSuccess(cjoAddon::translate(15,"msg_item_saved"));
        	}
        }
    }
    $form->show();
...
$cols['domain'] = new resultColumn('domain', cjoAddon::translate(15,'label_domain'));
$cols['domain']->setOptions(OPT_SORT);

$cols['servername'] = new resultColumn('servername', cjoI18N::translate('label_servername'));
$cols['servername']->setOptions(OPT_SORT);

$cols['error_email'] = new resultColumn('error_email', cjoI18N::translate('label_error_email'));
$cols['error_email']->setOptions(OPT_SORT);

$cols['root_article_id'] = new resultColumn('root_article_id', cjoAddon::translate(15,'label_root_article_id'));
$cols['root_article_id']->setOptions(OPT_SORT);

$cols['start_article_id'] = new resultColumn('start_article_id', cjoAddon::translate(15,'label_start_article_id'));
$cols['start_article_id']->setOptions(OPT_SORT);

$cols['notfound_article_id'] = new resultColumn('notfound_article_id', cjoI18N::translate('label_notfound_article_id'));

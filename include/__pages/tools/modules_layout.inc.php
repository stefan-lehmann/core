...
foreach ($templates as $c_tmpl_id => $c_tmpl_name){
    ...
    foreach(cjoProp::get('CTYPE') as $c_ctype_id=>$c_ctype_name){
        ...
        $input_path  = cjoModulTemplate::getTemplatePath($oid,$c_tmpl_id,$c_ctype_id,'input', false);
        $output_path = cjoModulTemplate::getTemplatePath($oid,$c_tmpl_id,$c_ctype_id,'output', false);

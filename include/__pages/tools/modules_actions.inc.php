...
if ($function == 'add') {
		...
		$sql->statusQuery("INSERT INTO ".TBL_MODULES_ACTIONS." SET module_id='".$oid."', action_id='".$action_id."'",
		                  cjoI18N::translate("msg_action_updated"));
...
$cols['name'] = new resultColumn('name', cjoI18N::translate("label_actions"));
...
// Lösch link
$cols['delete'] = new staticColumn('<img src="img/silk_icons/cross.png" alt="'.cjoI18N::translate("button_delete").'" />', NULL);
...
$add_action = '<tr>' .
			  ...
			  '	<td class="icon"><input type="image" src="img/silk_icons/add.png" title="'.cjoI18N::translate("button_add").'" value="'.cjoI18N::translate("button_add").'" alt="+" /></td>' .
			  '</tr>';

$list->setVar(LIST_VAR_BEFORE_DATAHEAD, '<a name="function"></a>');
$list->setVar(LIST_VAR_AFTER_DATA, $add_action);
$list->setVar(LIST_VAR_NO_DATA, cjoI18N::translate("msg_no_actions_connected_to_module"));

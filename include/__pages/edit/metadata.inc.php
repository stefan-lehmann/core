...
//Fields
$fields['file'] = new cjoMediaButtonField('file', cjoI18N::translate('label_meta_image'), array('preview' => array('enabled' => true)));
$fields['file']->needFullColumn(true);

$fields['title'] = new textField('title', cjoI18N::translate("label_meta_title"));

$fields['author'] = new textField('author', cjoI18N::translate("label_author"));

$fields['keywords'] = new textAreaField('keywords', cjoI18N::translate("label_keywords"));

$fields['description'] = new textAreaField('description', cjoI18N::translate("label_description"));
...
//Add Fields:
$section = new cjoFormSection(TBL_ARTICLES, cjoI18N::translate("title_metadata"), array ('id' => $article_id, 'clang' => cjoProp::getClang()));

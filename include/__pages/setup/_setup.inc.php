...
cjoProp::setSubpage( cjo_request('subpage', 'string'));

$lang = cjo_request('lang', 'string', 'de');

if (cjo_post('cjoform_back_button', 'string') == cjoI18N::translate('button_back')) {
	cjoProp::setSubpage( cjo_request('prev_subpage', 'string'));
}

if (!cjoProp::getSubpage())  cjoProp::setSubpage( 'step1');


cjoSubPages::addPage(array(cjoProp::getSubpage(), 
                         'title' => 'SETUP', 
						 'important' => true,
                         'params' => array('page'=>'setup', 'subpage'=>cjoProp::getSubpage(), 'lang'=>$lang)));

...
//Fields
$fields['swfupload'] = new readOnlyField('container', cjoI18N::translate('label_file_upload'), array('class'=>'flash'), 'fsUploadProgress');
...
$fields['container'] = new readOnlyField('container', cjoI18N::translate('label_uploaded_media'), array('class'=>'floatbox'), 'cjo_uploads');
$fields['container']->needFullColumn(true);
$fields['container']->setContainer('div');
$fields['container']->setValue($uploads);
$fields['container']->setNote('<input type="button" value="'.cjoI18N::translate('label_select_deselect_all').'" id="select_al_uploads" />');
...
$fields['file_category'] = new readOnlyField('filecategory',cjoI18N::translate('label_file_category'));
$fields['file_category']->addAttribute('style', 'float: left');
$fields['file_category']->setValue(cjoSelectMediaCat::$sel_media->get(false));
...
$fields['buttons']->addButton('cjoform_sync_button',cjoI18N::translate('button_sync'), true, 'img/silk_icons/add.png');
$fields['buttons']->setButtonAttributes('cjoform_sync_button', 'id="cjoform_sync_button"');

//Add Fields:
$section = new cjoFormSection('', cjoI18N::translate("label_add_media"), array ('id' => ''));

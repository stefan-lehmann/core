...
if ($mode == 'groups' && ($function == 'add' || $function == 'edit')) {
    ...
    $fields['headline1']->setValue(cjoI18N::translate("label_common"));
    ...
    $fields['headline2']->setValue(cjoI18N::translate("label_articles"));
    ...
    $fields['headline3']->setValue(cjoI18N::translate("label_media_perm"));
    ...
    $fields['headline4']->setValue(cjoI18N::translate("label_module_perm"));
...
// Zugriff auf Module und Templates ----------------------------------------------------------------------------------------------------------------------------
    ...
    $fields['headline4a']->setValue(cjoI18N::translate("title_templates"));
    ...
    $fields['headline5']->setValue(cjoI18N::translate("label_options"));
    ...
    if (cjoProp::get('EXTRAPERM')) {
        ...
        $fields['headline6']->setValue(cjoI18N::translate("label_extra_perm"));
	...
	if ($function == 'add') {
		...
		$fields['headline7']->setValue(cjoI18N::translate("label_info"));

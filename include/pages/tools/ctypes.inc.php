...
foreach($CJO['CTYPE'] as $key => $val){
	...
	$fields['ctype_'.$key] = new textField($key, $I18N->msg("label_ctype").' (ID='.$key.')');
	$fields['ctype_'.$key]->addValidator('notEmpty', $I18N->msg("msg_ctype_name_notEmpty"), false, false);
...
$fields['ctype_add'] = new textField($add_key, $I18N->msg("label_add_ctype"));
...
//Add Fields:
$section = new cjoFormSection($CJO['CTYPE'], $I18N->msg("label_ctype"));
...
if ($form->validate()) {
	...
	if (!cjoAssistance::isWritable($CJO['FILE_CONFIG_CTYPES'])){

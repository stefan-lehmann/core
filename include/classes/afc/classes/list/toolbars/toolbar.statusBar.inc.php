...
class statusBar extends cjoListToolbar {
	...
	public function show() {
	    ...
	    $limit = $this->cjolist->listsql->limit;
		$this->cjolist->listsql->limit = array();
		$this->cjolist->rows = '';
		$this->cjolist->num_rows = '';
		$this->cjolist->steps = '';
		$this->cjolist->qry = $this->cjolist->listsql->getQry();
		...
		$this->cjolist->listsql->limit = $limit;

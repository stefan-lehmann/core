...
Language.syntax = [
   ...
   // { input : /(&lt;script.*?&gt;)(.*?)(&lt;\/script&gt;)/g, output : '<ins>$1</ins><ins>$2</ins><ins>$3</ins>' }, // script tags
    ...
    { input : /(VALUE|CJO_LINK_BUTTON|CJO_MEDIALIST_BUTTON|CJO_MEDIA_BUTTON|CJO_VALUE|CJO_HTML_VALUE|CJO_LINK|CJO_LINK_ID|CJO_FILE)(\[\d+\])/g, output : '<abbr>$1$2</abbr>' }, // Contejo replacements 1
    { input : /(CJO_PHP|CJO_ARTICLE_ID|CJO_CATEGORY_ID)/g, output : '<abbr>$1</abbr>' } // Contejo replacements 2
]
